...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 px-4 bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              AI Powered{' '}
              <span className="bg-gradient-to-r from-medical-600 to-primary-600 bg-clip-text text-transparent">
                Medical Image
              </span>{' '}
              Diagnosis
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-medical-600 to-primary-600 text-white font-semibold rounded-lg hover:from-medical-700 hover:to-primary-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Get Started
            ...
            <div className="relative z-10 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="aspect-square rounded-xl bg-gradient-to-br from-medical-100 to-medical-200 dark:from-medical-900/50 dark:to-medical-800/50 flex items-center justify-center">
                ...
                <div className="space-y-4">
                  <div className="aspect-square rounded-xl bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900/50 dark:to-primary-800/50 flex items-center justify-center">
