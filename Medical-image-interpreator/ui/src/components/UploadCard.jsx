    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-shadow duration-300">
      <div className="p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="p-3 rounded-xl bg-gradient-to-br from-medical-100 to-medical-200 dark:from-medical-900/50 dark:to-medical-800/50">
        ...
        {!preview ? (
          ...
          <div className="space-y-4">
            ...
            {isPredicting && (
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-medical-600 to-primary-600 h-2 rounded-full transition-all duration-300"
            ...
            <button
              ...
              className="w-full py-3 px-6 bg-gradient-to-r from-medical-600 to-primary-600 text-white font-semibold rounded-lg hover:from-medical-700 hover:to-primary-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isPredicting ? (
                <>
